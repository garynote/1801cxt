...
$ls->password2_e2 = array("Second Password - must be 6 characters and above", "二级密码 - 必须6个字以上","密碼 - 必須6個字以上");
...
if ($msg=="") {
	$rep = ggSaveMember($bankaccount,$phone,$wechat,$alipay,$whatsapp,$line,$bankname,$bankbranch);
}
...
function ggSaveMember($bankaccount,$wechat,$alipay,$bankname) {
	global $db,$user,$ls,$msg, $lang, $password2_5;
	$ret = 0;

	$rs1 = $db->query("update tblmember set bankaccount='$bankaccount',wechat='$wechat',alipay='$alipay',bankname='$bankname' where id = $user->id");
